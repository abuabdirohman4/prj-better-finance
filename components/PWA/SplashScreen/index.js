...
export default function SplashScreen() {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 transition-opacity duration-500 ${
      ...
      <div className="relative z-10 text-center">
        ...
        {/* App name */}
        <h1 className={`text-4xl font-bold text-white mb-2 transition-all duration-1000 delay-300 ${
        ...
        {/* Tagline */}
        <p className={`text-lg text-blue-100 transition-all duration-1000 delay-500 ${
          isAnimating ? 'translate-y-4 opacity-0' : 'translate-y-0 opacity-100'
        }`}>
