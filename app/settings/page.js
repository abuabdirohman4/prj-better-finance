...
export default function Settings() {
    ...
    const {
        ...
        error: budgetError,
    } = useBudgets(getDefaultSheetName(months));
    ...
    useEffect(() => {
        ...
        if (savedHiddenGoals) {
            try {
                ...
                console.error(
                    "Error parsing hidden goals state from cookies:",
                    error
                );
            }
        }
    ...
    const selectAllCategories = () => {
        ...
        setSelectedCategories(
            new Set(hiddenCategoriesList.map((item) => item.id))
        );
    };
        ...
        <main className="min-h-screen bg-gray-50">
            ...
            <div className="px-3 py-6 pb-24">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    <div className="p-6 border-b border-gray-100">
                        <h2 className="text-lg font-semibold text-gray-900 mb-2">
                            Hidden Goals Management
                        </h2>
                        <p className="text-sm text-gray-600">
                            Manage your hidden goals. You can unhide individual
                            goals or select multiple goals to unhide them all at
                            once.
                        </p>
                    </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-500 text-sm mt-2">
                                All your goals are currently visible
                            </p>
                        </div>
                    ) : (
                        <div className="p-6">
                            ...
                            <div className="flex items-center justify-between mb-4 p-3 bg-gray-50 rounded-lg">
                                <div className="flex items-center space-x-3">
                                    <span className="text-sm text-gray-600">
                                        {selectedGoals.size} of{" "}
                                        {hiddenGoalsList.length} selected
                                    </span>
                                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mt-6">
                    <div className="p-6 border-b border-gray-100">
                        <h2 className="text-lg font-semibold text-gray-900 mb-2">
                            Hidden Budgets Management
                        </h2>
                        <p className="text-sm text-gray-600">
                            Manage your hidden budget items. You can unhide
                            individual items or select multiple items to unhide
                            them all at once.
                        </p>
                    </div>
                    ...
                    {isBudgetLoading ? (
                        ...
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-600 font-semibold">
                                No hidden budget items
                            </p>
                            <p className="text-gray-500 text-sm mt-2">
                                All your budget items are currently visible
                            </p>
                        </div>
                    ) : (
                        <div className="p-6">
                            ...
                            <div className="flex items-center justify-between mb-4 p-3 bg-gray-50 rounded-lg">
                                <div className="flex items-center space-x-3">
                                    <span className="text-sm text-gray-600">
                                        {selectedBudgets.size} of{" "}
                                        {hiddenBudgetsList.length} selected
                                    </span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <button
                            ...
                            <div className="space-y-2">
                                {hiddenBudgetsList.map((item) => (
                                    <div
                                        ...
                                        className="flex items-center space-x-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 cursor-pointer -mx-2"
                                        onClick={() =>
                                            toggleBudgetSelection(item.id)
                                        }
                                        title="Click to select/deselect this budget item"
                                    >
                                        <input
                                            type="checkbox"
                                            checked={selectedBudgets.has(
                                                item.id
                                            )}
                                            onChange={() =>
                                                toggleBudgetSelection(item.id)
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mt-6">
                    <div className="p-6 border-b border-gray-100">
                        ...
                        <p className="text-sm text-gray-600">
                            Manage your hidden budget categories. You can unhide
                            entire categories to show all their items.
                        </p>
                    </div>
                    ...
                    {hiddenCategoriesList.length === 0 ? (
                        <div className="p-6 text-center">
                            ...
                            <p className="text-gray-500 text-sm mt-2">
                                All your budget categories are currently visible
                            </p>
                        </div>
                    ) : (
                        <div className="p-6">
                            ...
                            <div className="flex items-center justify-between mb-4 p-3 bg-gray-50 rounded-lg">
                                <div className="flex items-center space-x-3">
                                    <span className="text-sm text-gray-600">
                                        ...
                                        {hiddenCategoriesList.length} selected
                                    </span>
                                </div>
                                <div className="flex items-center space-x-2">
                                    <button
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mt-6">
                    <div className="p-6 border-b border-gray-100">
                        ...
                        <p className="text-sm text-gray-600">
                            Manage Progressive Web App cache and service worker
                            settings.
                        </p>
                    </div>
