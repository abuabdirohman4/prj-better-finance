                ...
                <div className="grid grid-cols-1 gap-4">
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                        ...
                        {goalsData &&
                            goalsData.length > 0 &&
                            (() => {
                                const totalCollected = goalsData.reduce(
                                    (sum, goal) =>
                                        sum +
                                        (parseFloat(
                                            goal.Collected ||
                                            ...
                                            >
                                                <div className="flex items-center justify-between mb-3">
                                                    <div className="flex items-center">
                                                        <div
                                                            className={`w-10 h-10 rounded-lg flex items-center justify-center mr-3 bg-gradient-to-r from-blue-500 to-blue-600`}
                                                        >
                                                ...
                                                <div className="flex items-center gap-3 mb-2">
                                                    ...
                                                    <span
                                                        className={`text-sm font-medium ${getGoalColors(overallProgress).text}`}
                                                    >
