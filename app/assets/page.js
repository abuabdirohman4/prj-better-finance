        ...
        <div className="relative z-10">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">Track your financial assets</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-3 pb-24">
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">Failed to fetch asset data. Please try again later.</p>
          </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">No assets available to display.</p>
          </div>
        )}
      </div>
    </main>
