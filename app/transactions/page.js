...
export default function Transactions() {
  ...
  return (
    <main className="mb-8">
      ...
      <div className="w-full min-h-screen max-w-md p-4 bg-white border border-gray-200 rounded-lg rounded-t-none shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
